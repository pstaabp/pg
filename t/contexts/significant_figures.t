...
# 	is $a1->exp,     1,           '0012.34 written as 1.234 * 10^1';
# 	is $a1->value,   '1.234E+01', 'Correct exponential/internal form';
...
# 	is $a2->exp,     -3,          '0.00314 = 3.14 * 10^(-3)';
# 	is $a2->value,   '3.14E-03',  'Correct exponential/internal form';
...
# 	is $a3->exp,     -3,            '0.0031400 = 3.1400 * 10^(-3)';
# 	is $a3->value,   '3.1400E-03',  'Correct exponential/internal form';
...
# 	is $a4->exp,     -1,           '0.31415 = 3.1415 * 10^(-1)';
# 	is $a4->value,   '3.1415E-01', 'Correct exponential/internal form';
...
# 	is $a5->exp,     2,             '216.100 = 2.16100 * 10^(2)';
# 	is $a5->value,   '2.16100E+02', 'Correct exponential/internal form';
...
# 	is $a6->exp,     6,                     '1230000 = 1.23 * 10^6';
# 	is $a6->value,   '1.23E+06',            'Correct exponential/internal form';
...
# 	is $a7->value,   '2E+00', 'Correct exponential/internal form';
...
# 	is $a8->exp,     0,            '-1.932 = -1.932 * 10^(0)';
# 	is $a8->value,   '-1.932E+00', 'Correct exponential/internal form';
...
# 	is $a9->exp,     7,                       '-12340000 = -1.234 * 10^(7)';
# 	is $a9->value,   '-1.234E+07',            'Correct exponential/internal form';
...
# 	is $a10->exp,     -8,                      '0.00000001234 = 1.234 * 10^(-11)';
# 	is $a10->value,   '1.234E-08',             'Correct exponential/internal form';
# 	is $a10->string,  '1.234E-08',             'Correct string output.';
# 	is $a10->TeX,     '{1.234\times 10^{-8}}', 'Correct TeX output.';

# 	ok my $a11 = Real('10', sigfigs => 'inf');
# 	is $a11->sigfigs, 'inf',  'This number has infinite sigfigs.';
# 	is $a11->exp,     0,      'infinite sigfig numbers have exp = 0';
# 	is $a11->value,   '10',   'The number is stored in non-exponential form.';
...
# 	is $a1->value,  '1.2345E+01', 'Ensure that the internal storage of 12.345 is correct.';
...
# 	# is $a2->value, '1.0E+02', 'Ensure that the internal storage of 1.0 * 10^2 is correct.';

# };

# # subtest 'Create numbers with significant digits using SigFig' => sub {
# # 	my $a1 = SigFigNumber(10000,3);
# # 	is $a1->value, 100, 'Test for int value for x=10000 with 3 sig figs';
...
# # 	is $a2->value, 1234, 'Test for int value for x=12.3456 with 4 sig figs';
...
# # 	is $a3->value, 123450, 'Test for int value for x=123.45 with 6 sig figs';
...
# # 	is $a4->value, 2000, '2 with 4 significant figures is 2.000';
...
# 	is $a1->value,   '1.2346E+01', 'The value is now 1.2346E+01';
...
# 	is $a2->value,      '-1.234500E+02', "The internal value is '-1.2345E+02'";
# };

# subtest 'Multiplying two constants' => sub {
# 	my $a1 = Real('12.34') * Real('0.314');
# 	is $a1->value,   '3.87E+00', '12.34*0.314 = 3.87 (3 sigfigs)';
# 	is $a1->sigfigs, 3,          '12.34*0.314 = 3.87 (3 sigfigs)';
# 	is $a1->exp,     0,          '12.34*0.314 = 3.87 (3 sigfigs)';

# 	my $a2 = Real('16.100') * Real('0.00043923');
# 	is $a2->value,   '7.0716E-03', '16.100*0.00043923 = 0.0070716 (5 sigfigs)';
# 	is $a2->sigfigs,  5,           '16.100*0.00043923 = 0.0070716 (5 sigfigs)';
# 	is $a2->exp,     -3,           '16.100*0.00043923 = 7.0716 * 10^(-3)';

# 	my $a3 = Real('2.6') * Real('173.832');
# 	is $a3->value,   '4.5E+02', '2.6*173.832 = 450 (2 sigfigs)';
# 	is $a3->sigfigs, 2,         '2.6*173.832 = 450 (2 sigfigs)';
# 	is $a3->exp,     2,         '2.6*173.832 = 4.50 * 10^(2)';

# 	my $a4 = Real('7', sigfigs => 'inf') * Real('82.202');
# 	is $a4->value,   '5.7541E+02', "The value of 7*82.202 is '5.7541E+02'.";
# 	is $a4->sigfigs, 5,            '7*82.202 = 575.41 has 5 sig figs.';
# 	is $a4->exp,     2,            '7*82.202 = 575.41 = 5.7541 * 10^2';
# };

# subtest 'Adding two constants' => sub {
# 	my $a1 = Real('12.34') + Real('0.314');
# 	is $a1->value,   '1.265E+01', '12.34+0.314=12.65';
# 	is $a1->sigfigs, 4,           '12.34+0.314=12.65 (check sigfigs)';
# 	is $a1->exp,     1,           '12.34+0.314 = 1.265 * 10^1';

# 	my $a2 = Real('1.234') + Real('2');
# 	is $a2->value,   '3E+00', '1.234 + 2 = 3';
# 	is $a2->sigfigs, 1,       '1.234 + 2 = 3 (check sigfigs)';
# 	is $a2->exp,     0,       '1.234 + 2 = 3 * 10^0 (check exp)';

# 	my $a3 = Real('1.234') + Real('2.0');
# 	is $a3->value,   '3.2E+00', '1.234 + 2.0 = 3.2E+00';
# 	is $a3->sigfigs, 2,         '1.234 + 2.0 = 3.2 (check sigfigs)';
# 	is $a3->exp,     0,         '1.234 + 2.0 = 3.2 * 10^0 (check exp)';

# 	my $a4 = Real('0.01234') + Real('2.0');
# 	is $a4->value,   '2.0E+00', '0.01234+2.0=2.0';
# 	is $a4->sigfigs, 2,         '0.01234+2.0=2.0 (check sigfigs)';
# 	is $a4->exp,     0,         '0.01234+2.0=2.0 * 10^0 (check exp)';

# 	my $a5 = Real('-12.3') + Real('14.8676');
# 	is $a5->value, '2.6E+00', '-12.3 + 14.8678 = 2.6 = 2.6E+00 (check value)';

# };

# subtest 'Subtracting two constants' => sub {
# 	my $a1 = Real('12.34') - Real('0.314');
# 	is $a1->value,   '1.203E+01', '12.34-0.314=12.03 (check value)';
# 	is $a1->sigfigs, 4,           '12.34-0.314=12.03 (check sigfigs)';

# 	my $a2 = Real('20') - Real('10.645');
# 	is $a2->value,   '1E+01', '20-10.645 = 10 = 1E+01 (check value)';
# 	is $a2->sigfigs, 1,       '20-10.645 = 10 (1 sig fig)';

# 	my $a3 = Real('2') - Real('1.234');
# 	is $a3->value,   '1E+00', '2-1.234 = 1 = 1E+00 (check value)';
# 	is $a3->sigfigs, 1,       '2-1.234 = 1 (check sigfigs)';

# 	my $a4 = Real('2.0') - Real('1.234');
# 	is $a4->value,   '8E-01', '2.0-1.234 = 0.8 = 8E-0.1';
# 	is $a4->sigfigs, 1,       '2.0 - 1.234 = 0.8 (1 sig fig)';

# 	my $a5 = Real('10.49827') - Real('2.37');
# 	is $a5->value,   '8.13E+00', '10.49827 - 2.37 = 8.13 = 8.13E+00';
# 	is $a5->sigfigs, 3,          '10.49827 - 2.37 = 8.13 (3 sigfigs)';

# 	my $a6 = Real('253.32') - Real('10.2');
# 	is $a6->value,   '2.431E+02', '253.32 - 10.2 = 243.1 = 2.431E+02';
# 	is $a6->sigfigs, 4,           '253.32 - 10.2 = 243.1 (4 sigfigs)';

# 	my $a7 = Real('12.34') - Real('12.21');
# 	is $a7->value, '1.3E-01', '12.34 - 12.21 = 0.13 = 1.3E-01';

# 	# my $a7 = Compute('2.0');
# 	# my $a8 = Compute('1.234');
# 	# my $a9 = $a7-$a8;
# 	# is $a9->value, '8.0E-01', '2.0-1.234 = 0.8 = 8E-01 (check value)';
# 	# is $a9->sigfigs, 1, '2.0-1.234 = 1 (check sigfigs)';
# 	# is $a9->exp, -1, '2.0-1.234 = 8 * 10^(-1) (check exp)';

# 	# my $a10 = Compute('2.0');
# 	# my $a11 = Compute('0.01234');
# 	# my $a12 = $a10-$a11;
# 	# is $a12->value, '2.0E+00', '2.0-0.01234 = 2.0 = 2.0E+00 (check value)';
# 	# is $a12->sigfigs, 2, '2.0-0.01234 = 2.0 (check sigfigs)';
# 	# is $a12->exp, 0, '2.0-0.01234 = 2.0 * 10^(-1) (check exp)';

# };

# subtest 'Division' => sub {
# 	my $a1 = Compute('1.000') / Compute('4.000');
# 	is $a1->value,   '2.500E-01', '1.000/4.000 = 0.2500 (check value)';
# 	is $a1->sigfigs,  4,          '1.000/4.000 = 0.2500 has 4 sigfigs';
# 	is $a1->exp,     -1,          '1.000/4.000 = 0.2500 = 2.500 * 10^(-1) (check exp)';

# 	my $a2 = Compute('1.0000') / Compute('4.00');
# 	is $a2->value,   '2.50E-01', '1.000/4.00 = 0.250 (check value)';
# 	is $a2->sigfigs,  3,         '1.0000/4.00 = 0.2500 has 3 sigfigs';
# 	is $a2->exp,     -1,         '1.0000/4.00 = 0.2500 = 2.50 * 10^(-1) (check exp)';
...
subtest 'Significant Figures for integers' => sub {
	...
	is $a1->value, '1.0E+02', '1.0 * 10^2 internally is 1.0E+02';
};
